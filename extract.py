...
dataPath = '../CROHME2019_data/Task1_onlineRec/subTask_symbols/Train/isolatedTrain2014/trainingSymbols/'
...
if __name__ == "__main__":
    ...
    for fileInkml in listFiles:
        ...
        writeLog("[" + str(cnt) + "/" + str(
            numberOfFile) + "]" + "Processed " + fileInkml + " --> " + targetFolder + fileName + ".png")
        try:
